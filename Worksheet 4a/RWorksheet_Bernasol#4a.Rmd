...
# 5. Read CSV data
```{r}
data <- read.table("/cloud/project/Worksheet 4a/import_march (1).csv", header = TRUE, sep = ",", stringsAsFactors = FALSE)
print("Imported Data:")
print(head(data))
```
...
for (i in 1:nrow(students_scores)) {
  ...
  highest_score <- sorted_scores[1]  # First element is the highest score
